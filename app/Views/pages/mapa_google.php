...
<div id="app" class="container-fluid">
    <div class="mapa-reclamos-contenedor">
        <div class="mapa-cambiar-proveedor-wrap">
            <a href="<?= base_url('/mapa_mapbox'); ?>" class="reclamos-btn reclamos-btn--sm mapa-cambiar-proveedor-btn">
                ...
                <div class="modal-body">
                    ...
                    <div class="mb-3">
                        ...
                        <div v-else>
                            ...
                            <p class="mb-0" style="font-size: 0.82rem; font-weight: 500; color: var(--color-medium-gray);">El punto se ubica automáticamente usando las coordenadas obtenidas de Google Maps.</p>
                        </div>
                    </div>
                </div>
